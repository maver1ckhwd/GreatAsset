    ...
    <section id="services" className="py-20 md:py-28 bg-muted-light/20 border-y border-border">
      <div className="max-w-7xl mx-auto px-6 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          <span className="text-xs text-supporting tracking-widest font-bold uppercase">SERVICE SPECTRUM</span>
            ...
            return (
              <div
                ...
                className={`relative bg-card border rounded-3xl p-8 shadow-sm transition-all duration-300 flex flex-col justify-between group ${
                  isHovered 
                    ? "border-supporting shadow-lg shadow-supporting/5 -translate-y-2" 
                    : "border-border hover:border-supporting/50"
                }`}
                onMouseEnter={() => setHoveredIndex(index)}
                onMouseLeave={() => setHoveredIndex(null)}
              >
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-supporting/10 text-supporting flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <IconComponent className="w-6 h-6" />
                  </div>
                  
                  <h3 className="font-display font-bold text-xl mb-3 text-primary group-hover:text-supporting transition-colors">
                    {service.title}
                  </h3>
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="text-xs font-bold text-supporting hover:text-primary flex items-center gap-1.5 transition-colors mt-2"
                  >
